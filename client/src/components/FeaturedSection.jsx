        ...
        <div className="w-full py-20 bg-white font-['Outfit']">
            <div className='max-w-[1080px] mx-auto px-6 flex flex-col items-center'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 w-full'>
                    {/* Essential check: Only map if bikes exists and has data */}
                    {bikes && bikes.length > 0 ? (
                        bikes.slice(0, 6).map((bikeData) => (
                            <BikeCard key={bikeData._id} bike={bikeData} />
                        ))
                    ) : (
                ...
                <div className='mt-16'>
                    ...
                    >
                        <span className='font-bold text-sm uppercase tracking-widest cursor-pointer'>
                            View All Rides
                        </span>
